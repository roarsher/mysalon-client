...
// import { cancelBooking, initiateRefund } from '../services/api';
...
//     try {
//       // Initiate refund first (if paid)
//       try {
//         await initiateRefund({ bookingId, reason: 'Customer cancelled' });
//         toast.info('Refund initiated. It will reflect in 5–7 business days.');
//       } catch { /* booking may not have been paid */ }
...
//   const isYourTurn   = position === 0 && status === 'waiting';

//   // Progress bar: 100% when you're first, 0% when far back
...
//           isYourTurn   ? 'bg-primary-50 animate-pulse' : 'bg-primary-50'
//         }`}>
//           {isCompleted ? '✅' : isCancelled ? '❌' : isInProgress ? '✂️' : isYourTurn ? '🔔' : '⏳'}
//         </div>

//         <h1 className="text-lg font-semibold text-gray-900 mb-1">
//           {isCompleted  ? 'Service Completed!' :
//            isCancelled  ? 'Booking Cancelled'  :
//            isInProgress ? 'You\'re being served!' :
...
//           <div className={`rounded-2xl p-5 mb-4 ${isYourTurn || isInProgress ? 'bg-secondary-50' : 'bg-primary-50'}`}>
//             <div className={`text-5xl font-bold mb-1 ${isYourTurn || isInProgress ? 'text-secondary' : 'text-primary'}`}>
//               {isInProgress ? '✂️' : position}
//             </div>
//             <div className={`text-sm font-medium ${isYourTurn || isInProgress ? 'text-secondary-dark' : 'text-primary'}`}>
...
//               <div
//                 className={`h-2 rounded-full transition-all duration-700 ${isYourTurn || isInProgress ? 'bg-secondary' : 'bg-primary'}`}
...
//             <span className="text-gray-700">{salonName}</span>
//           </div>
//           {services.length > 0 && (
//             <div className="flex justify-between">
...
//           <p>① Arrive at the salon when your turn is close</p>
//           <p>② Show your token <strong>{tokenNumber}</strong> at the counter</p>
//           <p>③ This page updates automatically every 15 seconds</p>
//         </div>
//       )}
