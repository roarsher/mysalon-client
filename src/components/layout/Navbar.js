...
// import { useLocation as useUserLocation, searchPlaces, reverseGeocode } from '../../context/LocationContext';
...
//     window.location.reload(); // refresh salon list with new location
//   };
